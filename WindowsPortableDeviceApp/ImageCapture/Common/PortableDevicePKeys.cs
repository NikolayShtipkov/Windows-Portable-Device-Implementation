...
{
    // From http://code.google.com/p/gzune/source/browse/trunk/zUnlock/portabledeviceconstants.cs
    class PortableDevicePKeys
    {
        static PortableDevicePKeys()
        {
            ...
            WPD_OBJECT_ORIGINAL_FILE_NAME.pid = 12; WPD_OBJECT_NON_CONSUMABLE.fmtid = new Guid(0xEF6B490D, 0x5CD8, 0x437A, 0xAF, 0xFC, 0xDA, 0x8B, 0x60, 0xEE, 0x4A, 0x3C); WPD_OBJECT_NON_CONSUMABLE.pid = 13;
            ...
            WPD_OBJECT_DATE_CREATED.pid = 18; WPD_OBJECT_DATE_MODIFIED.fmtid = new Guid(0xEF6B490D, 0x5CD8, 0x437A, 0xAF, 0xFC, 0xDA, 0x8B, 0x60, 0xEE, 0x4A, 0x3C);
            ...
            WPD_OBJECT_CAN_DELETE.pid = 26; WPD_FUNCTIONAL_OBJECT_CATEGORY.fmtid = new Guid(0x8F052D93, 0xABCA, 0x4FC5, 0xA5, 0xAC, 0xB0, 0x1D, 0xF4, 0xDB, 0xE5, 0x98);
            WPD_FUNCTIONAL_OBJECT_CATEGORY.pid = 2;
            WPD_FOLDER_CONTENT_TYPES_ALLOWED.fmtid = new Guid(0x7E9A7ABF, 0xE568, 0x4B34, 0xAA, 0x2F, 0x13, 0xBB, 0x12, 0xAB, 0x17, 0x7D); WPD_FOLDER_CONTENT_TYPES_ALLOWED.pid = 2; WPD_IMAGE_BITDEPTH.fmtid = new Guid(0x63D64908, 0x9FA1, 0x479F, 0x85, 0xBA, 0x99, 0x52, 0x21, 0x64, 0x47, 0xDB);
